...
const sq: Translations = {
  ...
  themes: {
    ...
    eyebrow: "Dizajne Ekskluzive",
    hint: "Klikoni Preview për ta parë ftesën live, pastaj Porosit via WhatsApp.",
    catalogTitle: "Të gjitha modelet",
    catalogSubtitle: "Shfletoni, krahasoni dhe zgjidhni ftesën tuaj",
    catalogHint: "Çdo model ka animacion hapjeje, RSVP, countdown, galeri dhe hartë — me tekstin tuaj personal.",
    explore: "Shiko",
    preview: "Preview",
    order: "Porosit",
    showAll: "Shiko të gjitha modelet",
    backHome: "Kthehu te faqja kryesore",
    modelsCount: "modele ftesash",
    moreThemes: "Më shumë tema",
    premiumDemos: {
      eyebrow: "Demot tona premium",
      title: "Provo ftesat live",
      subtitle: "Katër demo të plota me animacion hapjeje, muzikë dhe seksione interaktive — kliko për ta hapur.",
    },
    badges: {
      new: "E re ✨",
